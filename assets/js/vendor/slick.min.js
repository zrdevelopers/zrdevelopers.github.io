  ...
  ((s =
              ...
              i({ animStart: o.currentLeft }).animate(
                { animStart: t },
                {
                  ...
                  step: function (i) {
                    (i = Math.ceil(i)),
                      !1 === o.options.vertical
                        ? ((e[o.animType] = 'translate(' + i + 'px, 0px)'), o.$slideTrack.css(e))
                        : ((e[o.animType] = 'translate(0px,' + i + 'px)'), o.$slideTrack.css(e));
                  },
                  complete: function () {
                    s && s.call();
                  }
    ...
    (s.prototype.applyTransition = function (i) {
      ...
      !1 === t.options.fade
        ...
        : (s[t.transitionType] = 'opacity ' + t.options.speed + 'ms ' + t.options.cssEase),
    ...
    (s.prototype.buildDots = function () {
      ...
      if (!0 === e.options.dots) {
        for (
          e.$slider.addClass('slick-dotted'), s = i('<ul />').addClass(e.options.dotsClass), t = 0;
          t <= e.getDotCount();
          t += 1
        )
    ...
    (s.prototype.buildRows = function () {
      ...
      if (
        ...
        for (
          l = this.options.slidesPerRow * this.options.rows, o = Math.ceil(n.length / l), i = 0;
          i < o;
          i++
        ) {
      ...
      this.options.dots &&
        ...
        !0 === this.options.arrows &&
          ...
          !0 === this.options.accessibility &&
            (this.$prevArrow && this.$prevArrow.off('keydown.slick', this.keyHandler),
    ...
    (s.prototype.fadeSlide = function (i, t) {
      ...
      !1 === s.cssTransitions
        ? (s.$slides.eq(i).css({ zIndex: s.options.zIndex }),
          s.$slides.eq(i).animate({ opacity: 1 }, s.options.speed, s.options.easing, t))
        : (s.applyTransition(i),
    ...
    (s.prototype.getDotCount = function () {
      ...
      if (!0 === this.options.infinite) {
        ...
        s =
          1 +
          Math.ceil((this.slideCount - this.options.slidesToShow) / this.options.slidesToScroll);
      return s - 1;
    }),
    (s.prototype.getLeft = function (i) {
      ...
      return (
            ...
            n.slideCount % n.options.slidesToScroll != 0 &&
              ...
              (i > n.slideCount
                ? ((n.slideOffset = -(
                  ...
                  (l = -((n.options.slidesToShow - (i - n.slideCount)) * s * 1)))
                : ((n.slideOffset = -(
        ...
        (t =
          !1 === n.options.vertical ? -(i * n.slideWidth * 1) + n.slideOffset : -(i * s * 1) + l),
    ...
    (s.prototype.getSlideCount = function () {
      ...
      return (
        (s =
          !0 === e.options.centerMode ? e.slideWidth * Math.floor(e.options.slidesToShow / 2) : 0),
      ...
      t.$slides
        ...
        null !== t.$dots &&
          (t.$slides.not(t.$slideTrack.find('.slick-cloned')).each(function (s) {
            var o = e.indexOf(s);
            i(this).attr({ role: 'tabpanel', id: 'slick-slide' + t.instanceUid + s, tabindex: -1 }),
              -1 !== o &&
                i(this).attr({ 'aria-describedby': 'slick-slide-control' + t.instanceUid + o });
          }),
          t.$dots
            .attr('role', 'tablist')
            .find('li')
    ...
    (s.prototype.lazyLoad = function () {
      ...
      if (
        (!0 === n.options.centerMode
          ? !0 === n.options.infinite
            ? (o =
                ...
                2)
            : ((e = Math.max(0, n.currentSlide - (n.options.slidesToShow / 2 + 1))),
        ...
        for (
          ...
          l < 0 && (l = n.slideCount - 1), (s = (s = s.add(d.eq(l))).add(d.eq(r))), l--, r++;
      t(s),
        n.slideCount <= n.options.slidesToShow
          ...
          : n.currentSlide >= n.slideCount - n.options.slidesToShow
            ...
            : 0 === n.currentSlide &&
              t(n.$slider.find('.slick-cloned').slice(-1 * n.options.slidesToShow));
    }),
        ...
        for (t in ((o.respondTo = o.options.respondTo || 'window'), n))
          if (((e = o.breakpoints.length - 1), n.hasOwnProperty(t))) {
            for (s = n[t].breakpoint; e >= 0; )
              o.breakpoints[e] && o.breakpoints[e] === s && o.breakpoints.splice(e, 1), e--;
    ...
    (s.prototype.removeSlide = s.prototype.slickRemove =
      function (i, t, s) {
        ...
        if (
          ((i =
            'boolean' == typeof i ? (!0 === (t = i) ? 0 : e.slideCount - 1) : !0 === t ? --i : i),
            ...
            : ((o = this.slideCount % this.options.slidesToShow),
              ...
              this.slideCount - i < this.options.slidesToShow
                ...
                : s
                    ...
                    .addClass('slick-active')
                    .attr('aria-hidden', 'false'));
      ('ondemand' !== this.options.lazyLoad && 'anticipated' !== this.options.lazyLoad) ||
        this.lazyLoad();
    }),
    (s.prototype.setupInfinite = function () {
      ...
      if (
        ...
        for (
          e = !0 === o.options.centerMode ? o.options.slidesToShow + 1 : o.options.slidesToShow,
            t = o.slideCount;
          t > o.slideCount - e;
          t -= 1
        )
    ...
    (s.prototype.selectHandler = function (t) {
      var s = parseInt(
        (i(t.target).is('.slick-slide') ? i(t.target) : i(t.target).parents('.slick-slide')).attr(
          'data-slick-index'
        )
      );
      s || (s = 0),
    ...
    (s.prototype.swipeDirection = function () {
      ...
      return (
        ...
        (e = Math.round(
          (180 * (s = Math.atan2((t = this.touchObject.startY - this.touchObject.curY), i))) /
            Math.PI
        )) < 0 && (e = 360 - Math.abs(e)),
        e <= 45 && e >= 0
          ? !1 === this.options.rtl
    ...
    (s.prototype.swipeEnd = function (i) {
      ...
      if (
        ...
        return !1;
      if (
        (!0 === e.touchObject.edgeHit && e.$slider.trigger('edge', [e, e.swipeDirection()]),
        ...
        'vertical' != s &&
          (e.slideHandler(t), (e.touchObject = {}), e.$slider.trigger('swipe', [e, s]));
      } else
