...
!(function () {
  ...
  (function () {
    ...
    var E = N[n],
      ...
      _ = !1;
    M &&
      ((_ = (t.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(t.readyState)) ||
      ...
      Z = function (c) {
        var l = c.children,
          ...
          M = {
            ...
            children: [{ tag: 'path', attributes: k({}, m.attributes, r.path, { fill: 'black' }) }]
          },
        ...
        return (
          l.push(o, {
            tag: 'rect',
            attributes: k(
              { fill: 'currentColor', 'clip-path': 'url(#' + H + ')', mask: 'url(#' + n + ')' },
              Q
            )
          }),
      ...
      cc = function (c) {
        ...
        if (G(a) && h.found && !v.found) {
          var m = h.width / h.height / 2,
            t = 0.5;
          z.style = K(
            k({}, e, { 'transform-origin': m + a.x / 16 + 'em ' + (t + a.y / 16) + 'em' })
          );
        }
    ...
    function vc(c) {
      var l = c.content,
        ...
        m = c.watchable,
        t = void 0 !== m && m,
        s = k({}, a.attributes, e ? { title: e } : {}, { class: a.classes.join(' ') });
      t && (s[V] = '');
      var r,
        f,
        M,
      ...
      G(z) &&
        ((p.transform =
          ((f = (r = { transform: z, startCentered: !0, width: h, height: v }).transform),
          (M = r.width),
          (n = void 0 === M ? H : M),
          (o = r.height),
          (C = void 0 === o ? H : o),
          ...
          (d +=
            (u = void 0 !== L && L) && i
              ? 'translate(' + (f.x / F - n / 2) + 'em, ' + (f.y / F - C / 2) + 'em) '
              : u
                ? 'translate(calc(-50% + ' + f.x / F + 'em), calc(-50% + ' + f.y / F + 'em)) '
      ...
      return (
        ...
        e && g.push({ tag: 'span', attributes: { class: 'sr-only' }, children: [e] }),
        g
      );
    }
    var zc = function () {},
      ec = O.measurePerformance && r && r.mark && r.measure ? r : { mark: zc, measure: zc },
      ac = 'FA "5.0.8"',
      mc = function (c) {
        ec.mark(ac + ' ' + c + ' ends'),
        ...
        var z,
          ...
          f =
            void 0 !== v
              ...
              : l;
        for (void 0 === h ? ((z = 1), (a = c[s[0]])) : ((z = 0), (a = h)); z < r; z++)
          a = f(a, c[(e = s[z])], e, c);
        return a;
      },
      rc = E.styles,
          ...
          if (c) {
            ...
            return ll(k({ type: 'icon' }, c), function () {
              return (
                ...
                O.autoA11y &&
                  (s
                    ? (i['aria-labelledby'] = O.replacementClass + '-title-' + B())
                    : (i['aria-hidden'] = 'true')),
                hc({
                  icons: {
                    main: Zc(C),
                        ...
                        D(c).forEach(function (c) {
                          if (
                            ('childList' === c.type &&
                              ...
                              !pc(c.addedNodes[0]) &&
                              (O.searchPseudoElements && v(c.target), l(c.target)),
                            'attributes' === c.type &&
                              c.target.parentNode &&
