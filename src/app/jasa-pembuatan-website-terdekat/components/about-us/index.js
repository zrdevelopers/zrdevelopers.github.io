...
const Index = () => {
  return (
    <section className="about-us" id="about-us" style={{ margin: 0 }}>
      <svg
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-6 ml-auto">
            <h3>Jasa Pembuatan Website Profesional Bergaransi</h3>
            <div>
              <p>
                <strong>ZRDigitalTech</strong> adalah penyedia{' '}
                <strong>jasa pembuatan website profesional bergaransi</strong> untuk UMKM, bisnis
                lokal, dan personal brand. Kami siap membantu Anda memiliki website yang menarik,
                cepat, dan terpercaya.
              </p>
              <p>
                Website dirancang dengan tampilan modern, kecepatan optimal, responsif di semua
                perangkat, serta dioptimalkan untuk mesin pencari (<strong>SEO</strong>) agar mudah
                ditemukan di Google.
              </p>
              <p>
                Nikmati kemudahan: <strong>gratis revisi</strong>,{' '}
                <strong>bayar setelah website jadi</strong>, dan <strong>dukungan teknis</strong>{' '}
                yang siap membantu kapan pun dibutuhkan. Konsultasi gratis sekarang juga!
              </p>
            </div>
          </div>
