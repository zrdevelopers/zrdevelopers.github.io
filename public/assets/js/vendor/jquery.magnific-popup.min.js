 ...
 * Copyright (c) 2016 Dmitry Semenov; */ !(function (e) {
  ...
  var k,
    ...
    P = 'inline',
    T = function () {
      S && (_.after(S.addClass(k)).detach(), (S = null));
    };
      ...
      getInline: function (i, n) {
        if ((T(), i.src)) {
          ...
          if (r.length) {
            ...
            a &&
              a.tagName &&
              (_ || ((_ = C((k = o.hiddenClass))), (k = 'mfp-' + k)),
              (S = r.after(_).detach().removeClass(k))),
  ...
  e.magnificPopup.registerModule('image', {
    ...
    proto: {
      ...
      getImage: function (i, n) {
        var o = 0,
          ...
          a = function () {
            i &&
              (i.img.off('.mfploader'),
              i === t.currItem &&
                (t._onImageHasSize(i), t.updateStatus('error', s.tError.replace('%url%', i.src))),
              (i.hasSize = !0),
              (i.loaded = !0),
              (i.loadError = !0));
          },
        ...
        return (
          t._parseMarkup(n, { title: F(i), img_replaceWith: i.img }, i),
          t.resizeImage(),
          i.hasSize
            ? (B && clearInterval(B),
              i.loadError
    ...
    e.magnificPopup.registerModule('zoom', {
      ...
      proto: {
        ...
        _getOffset: function (i) {
          ...
          return (
            (void 0 === L && (L = void 0 !== document.createElement('p').style.MozTransform), L)
  ...
  e.magnificPopup.registerModule(H, {
    ...
    proto: {
      ...
      getIframe: function (i, n) {
        ...
        var a = {};
        return (
          r.srcAction && (a[r.srcAction] = o), t._parseMarkup(n, a, i), t.updateStatus('ready'), n
        );
      }
    }
  });
