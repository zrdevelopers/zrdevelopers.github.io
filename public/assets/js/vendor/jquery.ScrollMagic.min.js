      ...
      (this.on = function (e, t) {
        ...
        f
          .on('change.internal', function (e) {
            'loglevel' !== e.what &&
              'tweenChanges' !== e.what &&
              ('triggerElement' === e.what ? E() : 'reverse' === e.what && f.update());
          })
      ...
      var S = function () {
        ...
        b = function (e) {
          if (o) {
            ...
            F(t, o.call(f)) &&
              !e &&
              (f.trigger('change', { what: t, newval: d[t] }), f.trigger('shift', { reason: t }));
          }
        },
        E = function (e) {
          var n = 0,
          ...
          if (s && r) {
            for (
              var o = s.info(), a = i.get.offset(o.container), l = o.vertical ? 'top' : 'left';
              ...
              return arguments.length
                ? ('duration' === e && (o = void 0),
                  F(e, t) &&
                    ...
                    r.shifts.indexOf(e) > -1 && f.trigger('shift', { reason: e })),
                  f)
                : d[e];
            });
        };
      ...
      var O = function (e) {
        ...
        D = function (e) {
          s &&
            ...
            s._setScrollPos(
              s.info('scrollPos') -
                ((e.wheelDelta || e[s.info('vertical') ? 'wheelDeltaY' : 'wheelDeltaX']) / 3 ||
                  30 * -e.detail)
            ));
        };
